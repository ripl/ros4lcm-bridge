...
# DEBUG only
DIRECTION = 'ros2lcm'
CONFIG_FILE = os.path.join( os.path.dirname(os.path.realpath(__file__)), '..', 'config', 'ros2lcm_bridge.xml')
...
if __name__ == '__main__':
    ...
    # write to file
    out_file = os.path.join(TEMP_DIR, 'autogenerated_%s_module.py' % DIRECTION)
